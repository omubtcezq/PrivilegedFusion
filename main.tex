...
As we assume that sensors are synchronised, we can capture the correlation between modified measurements exactly by considering the stacked measurement model for any privilege estimator $\mathsf{e}_{p,q}$ at time $k$,
\begin{equation}
