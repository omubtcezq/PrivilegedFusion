...
While only making transmitted information hold no information to eavesdroppers can be achieved with common public or symettric key encryption schemes [], distributed estimation tasks that preserve participant privacy often require schemes that allows some processing or data leakage []

A series of existing methods tackle these tasks individually and put forward methods to provide some level of participant privacy in a well defined distributed enviroment
