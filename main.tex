...
\begin{remark}
  We stress that the two bounds that will be guaranteed only bound the performances of honest-but-curious estimators. That is, nothing is said about estimators which may corrupt sensors to obtain keys beyond their privilege. Bounds on leakage caused by learning additional keys is beyond the scope of this work.
\end{remark}
